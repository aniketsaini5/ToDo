...
const BASE_URL = 'https://my-todo-s.vercel.app';
...
function addTask(event) {
    ...
    if (todoval) {
        axios.post(`${BASE_URL}/additem`, { todoval }) // Use full path for the deployed environment
            .then(response => {
...
window.onload = function() {
    axios.get(`${BASE_URL}/todos`) // Use full path for the deployed environment
        .then(response => {
...
function deleteTask(id) {
    axios.delete(`${BASE_URL}/deleteitem/${id}`) // Use full path for the deployed environment
        .then(response => {
...
function editTask(id, oldValue) {
    ...
    if (newTask && newTask.trim() !== '') {
        axios.put(`${BASE_URL}/updateitem/${id}`, { todoval: newTask }) // Use full path for the deployed environment
            .then(response => {
